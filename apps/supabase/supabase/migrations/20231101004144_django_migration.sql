...
create table "public"."holiday_planner_attraction" (
    "id" bigint generated by default as identity not null,
    "title" character varying(100) not null,
    "description" text not null,
    "is_child_friendly" boolean not null,
...
create table "public"."holiday_planner_category" (
    "id" bigint generated by default as identity not null,
    "title" character varying(100) not null
);
...
CREATE UNIQUE INDEX holiday_planner_attraction_category_id_key ON public.holiday_planner_attraction USING btree (category_id);

CREATE UNIQUE INDEX holiday_planner_attraction_pkey ON public.holiday_planner_attraction USING btree (id);

CREATE UNIQUE INDEX holiday_planner_category_pkey ON public.holiday_planner_category USING btree (id);
...
alter table "public"."holiday_planner_attraction" add constraint "holiday_planner_attraction_pkey" PRIMARY KEY using index "holiday_planner_attraction_pkey";

alter table "public"."holiday_planner_category" add constraint "holiday_planner_category_pkey" PRIMARY KEY using index "holiday_planner_category_pkey";
...
alter table "public"."holiday_planner_attraction" add constraint "holiday_planner_attr_category_id_fd937944_fk_holiday_p" FOREIGN KEY (category_id) REFERENCES holiday_planner_category(id) DEFERRABLE INITIALLY DEFERRED not valid;

alter table "public"."holiday_planner_attraction" validate constraint "holiday_planner_attr_category_id_fd937944_fk_holiday_p";

alter table "public"."holiday_planner_attraction" add constraint "holiday_planner_attraction_category_id_key" UNIQUE using index "holiday_planner_attraction_category_id_key";
